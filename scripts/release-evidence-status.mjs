...
export function buildReleaseEvidenceStatus(options = {}) {
  ...
  return {
    ...
    protectedReviewEvidenceDecision: refresh?.protectedReviewEvidenceDecision ?? "missing",
    protectedReviewEvidenceApprovedWorkerId: refresh?.protectedReviewEvidenceApprovedWorkerId ?? "",
    protectedReviewEvidenceApprovedRunId: refresh?.protectedReviewEvidenceApprovedRunId ?? "",
    protectedReviewEvidenceApprovedContractDecision: refresh?.protectedReviewEvidenceApprovedContractDecision ?? "",
    protectedReviewEvidenceFanoutPassedWorkerCount: refresh?.protectedReviewEvidenceFanoutPassedWorkerCount ?? 0,
    protectedReviewEvidenceFanoutWorkerCount: refresh?.protectedReviewEvidenceFanoutWorkerCount ?? 0,
