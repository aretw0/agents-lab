...
| [context-economy-calibration.md]({{ '/primitives/context-economy-calibration.html' | relative_url }}) | Memória / Observabilidade / Governança | Contrato evidence-first para calibrar técnicas de janela de contexto, cache, preload e compactação sem transformar ajuste local em regra global | Inicial |
...
| [external-influence-intake-template.md]({{ '/primitives/external-influence-intake-template.html' | relative_url }}) | Pesquisa / Governança / Continuidade | Intake target-agnostic e validável para transformar referência externa em trabalho local/worker-ready antes de qualquer promoção protected | Em evolução |
...
| [background-process-control.md]({{ '/primitives/background-process-control.html' | relative_url }}) | Operação / Governança / Segurança | Contrato local-first para planejar processos em background sem autorizar start/stop/restart automático | Em evolução |
| [development-velocity-pressure.md]({{ '/primitives/development-velocity-pressure.html' | relative_url }}) | Operação / Governança / Continuidade | Sinais para reduzir superfície, checkpointar ou reiniciar sessão quando o control plane começa a desacelerar o trabalho | Inicial |
...
| [quality-verification-gate.md]({{ '/primitives/quality-verification-gate.html' | relative_url }}) | Qualidade / Governança / Evidência | Gate language-agnostic para exigir evidência verificável antes de promover ou concluir fatias estratégicas | Em evolução |
| [tool-hygiene.md]({{ '/primitives/tool-hygiene.html' | relative_url }}) | Ferramentas / Qualidade / Manutenção | Scorecard report-only para higiene sintática, line budget e exceções justificadas em ferramentas | Em evolução |
...
| [textual-evaluation-discourse-check.md]({{ '/primitives/textual-evaluation-discourse-check.html' | relative_url }}) | Avaliação / Governança / Qualidade | Check textual para separar linguagem de conversa, claims canônicos e evidência antes de promover docs ou vault projections | Inicial |
