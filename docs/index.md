---
title: agents-lab
description: Minimal public map for agents-lab and the curated pi-stack.
---

# agents-lab

Local-first lab for reusable AI-agent primitives. Pi is the first runtime engine; `@aretw0/pi-stack` is the curated distribution surface.
...
- [`@aretw0/pi-stack`]({{ site.repo_url }}/tree/main/packages/pi-stack)
- [`@aretw0/git-skills`]({{ site.repo_url }}/tree/main/packages/git-skills)
- [`@aretw0/web-skills`]({{ site.repo_url }}/tree/main/packages/web-skills)
- [`@aretw0/pi-skills`]({{ site.repo_url }}/tree/main/packages/pi-skills)
- [`@aretw0/lab-skills`]({{ site.repo_url }}/tree/main/packages/lab-skills)

## Boundary

This site is a curated entrypoint, not a full dump of every note. Current operational docs live in guides, primitives and architecture. Research remains available for evidence, but it is not treated as the public source of truth until promoted.
