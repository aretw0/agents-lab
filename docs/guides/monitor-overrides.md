...
Investigação base: [202604-pi-hedge-monitor-investigation](https://github.com/aretw0/agents-lab/blob/main/experiments/202604-pi-hedge-monitor-investigation/README.md).
...
3. resolve modelo de classifier por configuração explícita (`classifierModel` ou `classifierModelByProvider`);
...
2. definir `defaultProvider` se o runtime precisar;
3. configurar `piStack.monitorProviderPatch.classifierModelByProvider` ou `classifierModel`;
