...
import {
	buildWorkspaceDiskCleanupPlan as buildWorkspaceDiskCleanupPlanImpl,
	formatWorkspaceDiskCleanupPlan,
	type WorkspaceDiskCleanupClass,
	type WorkspaceDiskCleanupCandidate,
	type WorkspaceDiskCleanupPlan,
} from "./machine-maintenance-disk-cleanup";
export { formatWorkspaceDiskCleanupPlan } from "./machine-maintenance-disk-cleanup";
...
export type { WorkspaceDiskCleanupClass, WorkspaceDiskCleanupCandidate, WorkspaceDiskCleanupPlan };
...
export function buildWorkspaceDiskCleanupPlan(input: {
	...
	return buildWorkspaceDiskCleanupPlanImpl(input, {
		cwd,
		thresholds,
		disk,
		classifyDisk: (freeMb) => classifyDiskPressure({ freeMb, totalMb: disk.totalMb, thresholds }),
	});
}
