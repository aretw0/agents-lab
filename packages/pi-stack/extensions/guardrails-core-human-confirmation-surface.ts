...
export function registerGuardrailsHumanConfirmationSurface(pi: ExtensionAPI): void {
  pi.registerTool({
    ...
    parameters: Type.Object({
      ...
      exact_confirmation_phrase: Type.Optional(Type.String({ description: "Fallback phrase when structured confirmation is unavailable." })),
    ...
    execute(_toolCallId, params) {
      ...
      const result = buildOperatorApprovalPacket({
        ...
        exactConfirmationPhrase: typeof p.exact_confirmation_phrase === "string" ? p.exact_confirmation_phrase : undefined,
