...
describe("background process control plan", () => {
  ...
  it("classifies lifecycle events with safe labels and no dispatch", () => {
    ...
    expect(late.stopSource).toBe("operator");
    ...
    expect(late.evidence).toContain("stopSource=operator");
