...
describe("ci workflow change-discovery report-only loop", () => {
  ...
  it("keeps actions runtime baseline on Node24 with pinned action SHAs", () => {
    const ciWorkflow = readRepoFile(".github/workflows/ci.yml");
    const setupAction = readRepoFile(".github/actions/setup/action.yml");
    ...
    expect(ciWorkflow).toContain("uses: ./.github/actions/setup");
    ...
    expect(setupAction).toContain("actions/setup-node@48b55a011bda9f5d6aeb4c2d9c7362e8dae4041e # v6.4.0");
    expect(setupAction).toContain("pnpm/action-setup@0e279bb959325dab635dd2c09392533439d90093 # v6.0.8");
  });
});
