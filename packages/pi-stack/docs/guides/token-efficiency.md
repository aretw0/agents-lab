...
A regra atual para contexto é: nenhuma técnica de cache, preload, compactação ou sumarização vira default permanente sem calibração. Use a primitiva [Calibração de Economia de Contexto](https://aretw0.github.io/agents-lab/primitives/context-economy-calibration.html) para registrar hipótese, baseline, variante, métricas, validade e rollback.
