...
- confirmar task ativa no board/caderno canônico do projeto
- revisar handoff/checkpoint recente se a sessão for nova
...
- criar mini-handoff inicial; no `agents-lab`, o template é:
...
- mini-handoff final + atualização do board/caderno canônico do projeto
