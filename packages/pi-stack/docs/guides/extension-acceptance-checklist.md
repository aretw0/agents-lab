...
> Para falhas já detectadas no pipeline do agents-lab, use o troubleshooting reativo em [ci-governance.md](https://github.com/aretw0/agents-lab/blob/main/docs/guides/ci-governance.md).
